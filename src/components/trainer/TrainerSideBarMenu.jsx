...
function TrainerSideMenuBar() {
    ...
    return (
        <div>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-10 left-0 z-40 w-56 h-screen transition-transform 
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link to='/trainer/profile' >
                                <p className="flex items-center p-2 rounded-lg   dark:text-white hover:bg-blue-200 dark:hover:bg-blue-200 group"     >
                        ...
                        <li>
                            <Link to='/trainer/foodmaster' >
                                <p href="#" className="flex items-center p-2 rounded-lg   dark:text-white hover:bg-blue-200 dark:hover:bg-blue-200 group"     >
