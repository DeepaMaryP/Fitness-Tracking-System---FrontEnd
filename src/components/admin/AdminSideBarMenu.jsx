...
function AdminSideBarMenu() {
    ...
    return (
        <div className="relative z-40">
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-[64px] left-0 z-40 w-56 h-[calc(100vh-64px)] 
                            transition-transform bg-white shadow-md 
                            ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} 
                            sm:translate-x-0`} aria-label="Sidebar"
            >

                <div className="h-full px-3 py-10 pt-20 overflow-y-auto">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link to="/admin/assignments" onClick={handleCloseSidebar}>
                                <p className="flex items-center p-2 rounded-lg hover:bg-blue-100">
                                    <svg
                                        ...
                                        strokeLinejoin="round"
                                    >
                                        <path d="M20 14.66V20a2 2 0 0 1-2 2H4a2 2 0 1-2-2V6a2 2 0 0 1 2-2h5.34" />
                         ...
                         <li>
                            <Link to='/admin/fitness' onClick={handleCloseSidebar}>
