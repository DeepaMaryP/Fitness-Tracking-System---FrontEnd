                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <button
                                ...
                                className="flex items-center w-full p-2 text-base  transition duration-75 rounded-lg group hover:bg-blue-200  dark:hover:bg-blue-200"   >
